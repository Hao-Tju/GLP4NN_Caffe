...
void im2col_gpu(const Dtype* data_im, const int channels,
  ...
  im2col_gpu_kernel<Dtype><<<CAFFE_GET_BLOCKS(num_kernels),
                             CAFFE_CUDA_NUM_THREADS, 0, GpuStreamPool::Get().cuda_stream(stream_id)>>>(
...
template void im2col_gpu<float>(const float* data_im, const int channels,
    ...
    const int dilation_h, const int dilation_w, float* data_col, int stream_id);
template void im2col_gpu<double>(const double* data_im, const int channels,
    const int height, const int width, const int kernel_h, const int kernel_w,
    const int pad_h, const int pad_w, const int stride_h, const int stride_w,
    const int dilation_h, const int dilation_w, double* data_col, int stream_id);
...
void im2col_nd_gpu(const Dtype* data_im, const int num_spatial_axes,
    ...
    const int* kernel_shape, const int* pad, const int* stride,
    const int* dilation, Dtype* data_col, int stream_id) {
  ...
  case 1:
    im2col_nd_gpu_kernel<Dtype, 1>  // NOLINT_NEXT_LINE(whitespace/operators)
        <<<CAFFE_GET_BLOCKS(num_kernels), CAFFE_CUDA_NUM_THREADS, 0, GpuStreamPool::Get().cuda_stream(stream_id)>>>(
...
template void im2col_nd_gpu<float>(const float* data_im,
    ...
    const int* im_shape, const int* col_shape,
    const int* kernel_shape, const int* pad, const int* stride,
    const int* dilation, float* data_col, int stream_id);
template void im2col_nd_gpu<double>(const double* data_im,
    const int num_spatial_axes, const int col_size,
    const int* im_shape, const int* col_shape,
    const int* kernel_shape, const int* pad, const int* stride,
    const int* dilation, double* data_col, int stream_id);
...
template void col2im_gpu<float>(const float* data_col, const int channels,
    ...
    const int pad_h, const int pad_w, const int stride_h,
    const int stride_w, const int dilation_h, const int dilation_w,
    float* data_im, int stream_id);
template void col2im_gpu<double>(const double* data_col, const int channels,
    const int height, const int width, const int kernel_h, const int kernel_w,
    const int pad_h, const int pad_w, const int stride_h,
    const int stride_w, const int dilation_h, const int dilation_w,
    double* data_im, int stream_id);
...
void col2im_nd_gpu(const Dtype* data_col, const int num_spatial_axes,
    ...
    const int* kernel_shape, const int* pad, const int* stride,
    const int* dilation, Dtype* data_im, int stream_id) {
  // num_axes should be smaller than block size
  DCHECK_LT(num_spatial_axes, CAFFE_CUDA_NUM_THREADS);
  switch (num_spatial_axes) {
  case 1:
    col2im_nd_gpu_kernel<Dtype, 1>  // NOLINT_NEXT_LINE(whitespace/operators)
          <<<CAFFE_GET_BLOCKS(im_size), CAFFE_CUDA_NUM_THREADS, 0, GpuStreamPool::Get().cuda_stream(stream_id)>>>(
...
template void col2im_nd_gpu<float>(const float* data_col,
    ...
    const int* im_shape, const int* col_shape,
    const int* kernel_shape, const int* pad, const int* stride,
    const int* dilation, float* data_im, int stream_id);
template void col2im_nd_gpu<double>(const double* data_col,
    const int num_spatial_axes, const int im_size,
    const int* im_shape, const int* col_shape,
    const int* kernel_shape, const int* pad, const int* stride,
    const int* dilation, double* data_im, int stream_id);
